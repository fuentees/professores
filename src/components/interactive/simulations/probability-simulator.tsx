...
export function ProbabilitySimulator() {
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6 sm:p-8">
      <div className="flex h-20 w-20 items-center justify-center rounded-xl border-2 border-simulation bg-simulation-soft text-3xl font-bold text-simulation">
        {lastRoll ?? "?"}
      </div>
          ...
          return (
            <div key={face} className="flex items-center gap-2 text-sm">
              ...
              <div className="h-4 flex-1 overflow-hidden rounded bg-muted">
                <div
                  className="h-full bg-simulation transition-all"
