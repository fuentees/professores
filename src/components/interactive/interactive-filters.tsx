...
export function InteractiveFilters({
  ...
  grades: InteractiveFilterOption[];
}) {
  ...
  function setFilter(key: "disciplina" | "serie", value: string | null) {
  ...
  // filtros secundários (busca/disciplina/série).
  ...
  const activeCount = (disciplina ? 1 : 0) + (serie ? 1 : 0);
